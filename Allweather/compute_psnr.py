...
if __name__ == "__main__":
    ...
    # path setting
    parser.add_argument('--path1', type=str,default= "F:/low_level_pkg/Datasets/all in one/ALLWeather/test/RainDrop/test_a/gt") # modify the experiments name-->modify all save path
    parser.add_argument('--path2', type=str,default= "./RainDrop/")
